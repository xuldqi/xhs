...
export const navigationStructure: NavigationItem[] = [
  {
    ...
    children: [
      ...
      { id: 'matrix-publisher', label: '矩阵发布台', path: '/tools/matrix-publisher', badge: 'new' },
      { id: 'matrix-review', label: '矩阵审核台', path: '/tools/matrix-review', badge: 'new' },
...
export const mobileNavigationStructure: NavigationItem[] = [
  ...
  { id: 'matrix-publisher', label: '矩阵发布台', path: '/tools/matrix-publisher' },
  { id: 'matrix-review', label: '矩阵审核台', path: '/tools/matrix-review' },
